...
int countInt = 0;
String countString = String(countInt);
...
void loop()
{
  ...
  countString = String(countInt);
  char data[] = "Hello World! #   ";
  String dataString = "Hello World! #";
  dataString += String(countInt);
...
//  }
//  Serial.println("");
  nrf24.send(data, sizeof(data)/sizeof(data[0]));
